...
public class OtherUtil
{
    ...
    {
        if(Grythvy.class.getPackage() != null && Grythvy.class.getPackage().getImplementationVersion() != null)
            return Grythvy.class.getPackage().getImplementationVersion();
        else
            return "UNKNOWN";
    }
    ...
    public static String getLatestVersion()
    {
        try
        {
            Response response = new OkHttpClient.Builder().build()
                    .newCall(new Request.Builder().get().url("https://api.github.com/repos/CyberFlameGO/MusicBot" +
